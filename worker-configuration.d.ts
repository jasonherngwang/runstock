/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1538c3c62a423b06fb3aabdf13babf12)
// Runtime types generated with workerd@1.20260301.1 2026-03-09 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "ConnectionManager";
	}
	interface Env {
		GPU_STOCK: KVNamespace;
		DB: D1Database;
		RUNPOD_API_KEY: string;
		CONNECTION_MANAGER: DurableObjectNamespace<import("./src/index").ConnectionManager>;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RUNPOD_API_KEY">> {}
}
